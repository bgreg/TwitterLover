...
describe "results" do 
  describe "form" do
    ...
    it "should respond page 1 number click" do 
      click_link "1"
      page.should have_css("div.tweet")
    end
  ...
  describe "pagination" do 
    before{ visit '/searches/tweet_search_results?lat=1&long=1&page=2&rad=200' }
    it { page.should have_css('span.next') }
    it { page.should have_css('span.last') }
    it { page.should have_css('span.page') }
    it { page.should have_css('span.current') }
  end
end
